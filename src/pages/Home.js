      ...
      <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
          <div class="resume-section-content">
            <h1 class="mb-0">
              Zeeshan
              <span class="text-primary">Shafiq</span>
            </h1>
            <div class="subheading mb-5">
              Ganj Shakar Colony Karachi· Jacker Street, Karachi  · (333) 322-9744 ·
              <a href="mailto:zeeshanchishti33@gmail.com">zeeshanchishti33@gmail.com</a>
            </div>
            <p class="lead mb-5">
            ...
            <div class="social-icons">
              <a class="social-icon" href="https://www.linkedin.com/in/zeeshan-khan-42b436251/">
                <i class="fab fa-linkedin-in"></i>
              </a>
              <a class="social-icon" href="https://github.com/zeeshanshafiq84">
                <i class="fab fa-github"></i>
              </a>
              <a class="social-icon" href="https://twitter.com/mistershan84?t=sQOV159GaFcI_iVpvzZf_A&s=08 ">
                <i class="fab fa-twitter"></i>
              </a>
              <a class="social-icon" href="https://www.facebook.com/virgiansshans?mibextid=ZbWKwL">
